...
/**
 * Options helper for Tiny Chemistry plugin.
 *
 * @module      tiny_chemistry/options
...
import {pluginName} from 'tiny_chemistry/common';
...
/**
 * Register the options for the Tiny Chemistry plugin.
 *
...
/**
 * Get the libraries configuration for the Tiny Chemistry plugin.
 *
 * @param {TinyMCE} editor
 * @returns {object}
 */
...
/**
 * Check if the TEX filter is active or not for the Tiny Chemistry plugin.
 *
 * @param {TinyMCE} editor
 * @returns {boolean}
 */
...
/**
 * Get the context id for the Tiny Chemistry plugin.
 *
 * @param {TinyMCE} editor
 * @returns {number}
 */
...
/**
 * Get the Tex Docs Url for the Tiny Chemistry plugin.
 *
 * @param {TinyMCE} editor
 * @returns {string}
 */
